...
partial class NotificationApiTest
{
    ...
    public static async Task UnsubscribeAsync_BotInfoGetResultIsFailure_ExpectUnknownFailure()
    {
        ...
        var actual = await api.UnsubscribeAsync(SomeUnsubscribeInput, TestContext.Current.CancellationToken);
    ...
    public static async Task UnsubscribeAsync_BotInfoGetResultIsSuccess_ExpectSearchForUserCalledOnce()
    {
        ...
        var api = new NotificationApi(mockDataverseApi.Object, mockBotApi.Object);
        _ = await api.UnsubscribeAsync(input, TestContext.Current.CancellationToken);
